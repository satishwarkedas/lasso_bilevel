function [beta, fval] = CVElasticNet1(ul, data, index_train)

problemName = 'Elastic Net CV';             % Test problem name

ulDim=2;                         % Number of UL dimensions
llDim=size(data,2)-1;            % Number of LL dimensions

%Upper level TP1 implemented
data_trainX = data(index_train,1:end-1);
data_trainY = data(index_train,end);
